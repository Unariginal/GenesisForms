...
public class GlowUtils {
    public static void applyGlowing(String id, String color, Pokemon pokemon, @Nullable PokemonEntity pokemonEntity) {
    ...
    public static void removeGlowing(String id, Pokemon pokemon, @Nullable PokemonEntity pokemonEntity) {
        ServerScoreboard scoreboard = GenesisForms.INSTANCE.server.getScoreboard();
